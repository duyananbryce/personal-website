...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF5] text-[#0a0a0a]">
      ...
      {/* 工作履历时间轴 */}
      <section className="py-10 px-6 lg:px-8 border-t border-[#E3D8AC]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-5xl font-bold text-[#0a0a0a] mb-4">工作履历</h2>
            <p className="text-lg text-[#0a0a0a]/80 max-w-4xl mx-auto font-light">
                ...
                <div className="ml-16">
                  <div className="bg-white p-4 rounded-2xl shadow-sm">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                      <div>
                        <h3 className="text-lg font-bold text-[#0a0a0a] mb-1">{experience.company}</h3>
                        <p className="text-base text-[#D97758] font-medium">{experience.position}</p>
                      </div>
                    ...
                    <p className="text-[#0a0a0a]/80 mb-3 leading-relaxed text-sm">
      ...
      <section className="py-20 px-6 lg:px-8 border-t border-[#E3D8AC] bg-[#FAFAF5]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* 猿辅导 */}
            <div className="bg-gradient-to-br from-[#E3D8AC] to-[#DEC8BC] rounded-2xl p-6 shadow-lg border border-[#D97758]/20">
              <div className="flex items-center mb-6">
                <div className="w-14 h-14 bg-[#D97758] rounded-xl flex items-center justify-center mr-4 shadow-md">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="group block bg-white/90 backdrop-blur-sm rounded-xl p-4 hover:bg-white hover:shadow-md transition-all duration-300 border border-[#D97758]/30"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-[#D97758] rounded-xl flex items-center justify-center shadow-sm">
                        <span className="text-white font-bold text-sm">抖</span>
                      </div>
                      <div>
                        <h4 className="font-bold text-[#0a0a0a] text-sm group-hover:text-[#D97758] transition-colors">小猿搜题</h4>
                        <p className="text-[#0a0a0a]/60 text-xs">抖音账号</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#0a0a0a]/40 group-hover:text-[#D97758] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-[#00A1D6] rounded-xl flex items-center justify-center shadow-sm">
            ...
            {/* 站酷网 */}
            <div className="bg-gradient-to-br from-[#DEC8BC] to-[#E8DFB7] rounded-2xl p-6 shadow-lg border border-[#D97758]/20">
              <div className="flex items-center mb-6">
                <div className="w-14 h-14 bg-[#D97758] rounded-xl flex items-center justify-center mr-4 shadow-md">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-[#0a0a0a] text-sm group-hover:text-[#D97758] transition-colors">站酷家的小Z老师</h4>
                        <p className="text-[#0a0a0a]/60 text-xs">抖音账号</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#0a0a0a]/40 group-hover:text-[#D97758] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-[#0a0a0a] text-sm group-hover:text-[#D97758] transition-colors">懂点儿设计</h4>
                        <p className="text-[#0a0a0a]/60 text-xs">抖音账号</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#0a0a0a]/40 group-hover:text-[#D97758] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* 即时设计 */}
            <div className="bg-gradient-to-br from-[#E8DFB7] to-[#E3D8AC] rounded-2xl p-6 shadow-lg border border-[#D97758]/20">
              <div className="flex items-center mb-6">
                <div className="w-14 h-14 bg-[#D97758] rounded-xl flex items-center justify-center mr-4 shadow-md">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-[#0a0a0a] text-sm group-hover:text-[#D97758] transition-colors">新来的设计师</h4>
                        <p className="text-[#0a0a0a]/60 text-xs">B站账号</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#0a0a0a]/40 group-hover:text-[#D97758] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-[#0a0a0a] text-sm group-hover:text-[#D97758] transition-colors">设计练习生-乘风</h4>
                        <p className="text-[#0a0a0a]/60 text-xs">B站账号</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#0a0a0a]/40 group-hover:text-[#D97758] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {Array.from({ length: 5 }, (_, i) => i + 1).map((pageNum) => (
              ...
              >
                <img
                  ...
                  className="w-full h-auto rounded-lg shadow-md transition-all duration-300 border-2 border-[#E3D8AC] hover:border-[#D97758]"
                />
              </div>
            ))}
            <div
            ...
            {Array.from({ length: 5 }, (_, i) => i + 1).map((pageNum) => (
              ...
              >
                <img
                  ...
                  className="w-full h-auto rounded-lg shadow-md transition-all duration-300 border-2 border-[#DEC8BC] hover:border-[#D97758]"
                />
              </div>
            ))}
            <div
            ...
            {Array.from({ length: 5 }, (_, i) => i + 1).map((pageNum) => (
              ...
              >
                <img
                  ...
                  alt={`产品企划第${pageNum}页`}
                  className="w-full h-auto rounded-lg shadow-md transition-all duration-300 border-2 border-[#E8DFB7] hover:border-[#D97758]"
                />
              </div>
            ))}
            <div
              ...
              >
                <div className="relative">
                  <img
                    ...
                    alt={`视频策划项目${itemNum}`}
                    className="w-full h-48 object-cover rounded-lg border-2 border-[#E3D8AC] hover:border-[#D97758] transition-all duration-300"
                  />
